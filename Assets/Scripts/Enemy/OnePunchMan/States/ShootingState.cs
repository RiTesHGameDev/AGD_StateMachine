...
namespace StatePattern.Enemy
{
    public class ShootingState : IState
    {
        ...
        public void Update()
        {
            ...
            Owner.SetRotation(RoationTowards(desiredRotation));
        ...
        private Quaternion RoationTowards(Quaternion desiredRoation) => Quaternion.LerpUnclamped(Owner.Rotation,desiredRoation,Owner.Data.RotationSpeed / 30 * Time.deltaTime);
