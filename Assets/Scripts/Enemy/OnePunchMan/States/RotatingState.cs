...
namespace StatePattern.Enemy
{
    public class RotatingState : IState
    {
        ...
        public RotatingState(OnePunchManStateMachine onePunchManStateMachine)
        {
        ...
        {
            return Vector3.up * Mathf.MoveTowardsAngle(Owner.Rotation.eulerAngles.y,targetRotation,
